  ...
  framePtr = F;
    ...
    Label1: {
      ...
      Label2: {
        F.line = 120;
          Label3: while (true) {
          if (!(i_637534256 < n_285212855)) break Label3;
            F.line = 49;
            iHEX60gensym4_285212870 = i_637534256;
            F.line = 49;
            ...
            F.line = 122;
            i_637534256 = addInt(i_637534256, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556486(f_33556487) {
  var result_33556488 = [[]];
    ...
    Label5: {
      var j_33556532 = 0;
      var colontmp__637534248 = 0;
      colontmp__637534248 = (i_33556497 - 1);
      var res_637534250 = colontmp__637534248;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_637534250)) break Label7;
            j_33556532 = res_637534250;
...
framePtr = F;
F.line = 61;
var data_637534210 = new FormData();
F.line = 61;
data_637534210.set("key0", "value0");
F.line = 61;
data_637534210.append("key1", "value1");
F.line = 61;
data_637534210.delete("key1");
if (!(data_637534210.has("key0"))) {
F.line = 61;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(12, 10) `data.hasKey(\"key0\")` "));
}

if (!((data_637534210.get("key0") == "value0"))) {
F.line = 61;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(13, 10) `data[\"key0\"] == \"value0\".cstring` "));
}

F.line = 61;
(() => { const frmdt = data_637534210; Array.from(frmdt.keys()).forEach((key) => frmdt.delete(key)) })();
if (!((Array.from(data_637534210.entries()).length == 0))) {
F.line = 61;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(15, 10) `data.len == 0` "));
}
