  ...
  framePtr = F;
    ...
    Label1: {
      ...
      Label2: {
        F.line = 120;
          Label3: while (true) {
          if (!(i_637534429 < n_285212855)) break Label3;
            F.line = 49;
            iHEX60gensym4_285212870 = i_637534429;
            F.line = 49;
            ...
            F.line = 122;
            i_637534429 = addInt(i_637534429, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556486(f_33556487) {
  var result_33556488 = [[]];
    ...
    Label5: {
      var j_33556532 = 0;
      var colontmp__637534421 = 0;
      colontmp__637534421 = (i_33556497 - 1);
      var res_637534423 = colontmp__637534421;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_637534423)) break Label7;
            j_33556532 = res_637534423;
...
function HEX3DHEX3D_637534221(x_637534223, y_637534224) {
  var result_637534225 = false;

  var F = {procname: "==.==", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/system/comparisons.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    F.line = 326;
    var sameObject_637534233 = false;
    F.line = 327;
    sameObject_637534233 = x_637534223 === y_637534224
    if (sameObject_637534233) {
    F.line = 328;
    result_637534225 = true;
    break BeforeRet;
    }
    
    if (!(((x_637534223).length == (y_637534224).length))) {
    F.line = 331;
    result_637534225 = false;
    break BeforeRet;
    }
    ...
    Label1: {
      ...
      var i_637534247 = 0;
      F.line = 75;
      var colontmp__637534414 = 0;
      F.line = 333;
      colontmp__637534414 = subInt((x_637534223).length, 1);
      F.line = 90;
      var res_637534416 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_637534416 <= colontmp__637534414)) break Label3;
            F.line = 333;
            i_637534247 = res_637534416;
            if (!((x_637534223[chckIndx(i_637534247, 0, (x_637534223).length - 1)] == y_637534224[chckIndx(i_637534247, 0, (y_637534224).length - 1)]))) {
            F.line = 335;
            result_637534225 = false;
            break BeforeRet;
            }
            ...
            F.line = 93;
            res_637534416 = addInt(res_637534416, 1);
          }
      };
    };
    F.line = 337;
...
function HEX3DHEX3D_637534279(x_637534281, y_637534282) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      var i_637534305 = 0;
      F.line = 75;
      var colontmp__637534434 = 0;
      F.line = 333;
      colontmp__637534434 = subInt((x_637534281).length, 1);
      F.line = 90;
      var res_637534435 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_637534435 <= colontmp__637534434)) break Label3;
            F.line = 333;
            i_637534305 = res_637534435;
            if (!((x_637534281[chckIndx(i_637534305, 0, (x_637534281).length - 1)] == y_637534282[chckIndx(i_637534305, 0, (y_637534282).length - 1)]))) {
            F.line = 335;
            result_637534283 = false;
            break BeforeRet;
            }
            ...
            F.line = 93;
            res_637534435 = addInt(res_637534435, 1);
          }
      };
    };
    F.line = 337;
...
var F = {procname: "module jscore_examples_1", prev: framePtr, filename: "/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim", line: 0};
framePtr = F;
if (!(HEX3DHEX3D_637534221(new Uint8Array([97, 98, 99, 100, 101]).copyWithin(0, 3, 4), [100, 98, 99, 100, 101]))) {
F.line = 119;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(8, 10) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(0, 3, 4) == @[\'d\', \'b\', \'c\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D_637534221(new Uint8Array([97, 98, 99, 100, 101]).copyWithin(1, 3), [97, 100, 101, 100, 101]))) {
F.line = 119;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(9, 10) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(1, 3) == @[\'a\', \'d\', \'e\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D_637534279(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2), [1, 2, 3, 1, 2]))) {
F.line = 119;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(10, 10) `[1, 2, 3, 4, 5].copyWithin(-2) == @[1, 2, 3, 1, 2]` "));
}

if (!(HEX3DHEX3D_637534279(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3), [4, 5, 3, 4, 5]))) {
F.line = 119;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(11, 10) `[1, 2, 3, 4, 5].copyWithin(0, 3) == @[4, 5, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D_637534279(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3, 4), [4, 2, 3, 4, 5]))) {
F.line = 119;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(12, 10) `[1, 2, 3, 4, 5].copyWithin(0, 3, 4) == @[4, 2, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D_637534279(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2, -3, -1), [1, 2, 3, 3, 4]))) {
F.line = 119;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(13, 10) `[1, 2, 3, 4, 5].copyWithin(-2, -3, -1) == @[1, 2, 3, 3, 4]` "));
}
...
framePtr = F;
F.line = 131;
var arrai_671088646 = [[1, 2, 3]];
if (!((arrai_671088646[0].shift() == 1))) {
F.line = 131;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_2.nim(9, 10) `arrai.shift() == 1` "));
}

if (!(HEX3DHEX3D_637534279(arrai_671088646[0], [2, 3]))) {
F.line = 131;
failedAssertImpl_251658292(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_2.nim(10, 10) `arrai == @[2, 3]` "));
}
